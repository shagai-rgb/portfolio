      ...
      <div className="head-container flex  lg:gap-12 ">
        ...
        <div className=" md:w-[320px] lg:w-[320px]   xl:w-[400px] h-[360px]">
          <div className="flex relative  w-[320px] h-[360px] xl:ml-20 xl:mr-10">
            <img
              src="/IMG_0034.jpg"
              className="absolute z-10 w-[280px] h-[320px] object-cover bg-white dark:bg-black	 p-2 "
              alt=""
            />
            <div className="absolute z-0 top-8 left-8  w-[280px] h-[320px] bg-gray-200 dark:bg-gray-600 p-2"></div>
          </div>
        </div>
      </div>
    </div>
