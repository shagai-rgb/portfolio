        ...
        <div className="flex flex-col items-center mx-4 lg:items-start lg:flex-row  md:w-auto md:px-1 md:mx-0 xl:[1280px] gap-12 ">
          <div className="w-72 h-[300px] lg:w-[440px] lg:h-[520px] xl:w-[584px] ">
            <div className="flex relative  lg:w-[440px] lg:h-[520px]  xl:mr-[144px]">
              <img
                src="/img-1.jpeg"
                className="absolute z-10 w-60 left-1/2 h-72 -translate-x-1/2 lg:translate-x-0 lg:left-[40px]  lg:w-[400px] lg:h-[480px] object-cover bg-white dark:bg-gray-900 p-2 "
                alt=""
              />
              <div className="absolute z-0 w-[264px] h-[272px] top-7 left-1/2 -translate-x-1/2 lg:left-0 lg:ml-0 lg:-translate-x-0  lg:w-[400px] lg:h-[480px] bg-gray-200 dark:bg-gray-600 p-2"></div>
            </div>
          </div>
          <div className="flex flex-col gap-6 items-left md:w-auto text-wrap ">
            ...
            <div className="flex flex-col gap-4">
              <p className="menu-para w-auto dark:text-gray-300">
              ...
              <div className="flex w-auto">
                <div className="flex flex-col gap-2.5 ">
                  <li className="menu-para dark:text-gray-300">
                ...
                <div>
                  <li className="menu-para dark:text-gray-300">Avid learner</li>
                  <li className="menu-para dark:text-gray-300">
